...
RoundInfo MakeRoundInfo() {
    ...
    locations[1] = 4;
    locations[2] = 4;
    locations[3] = RoundInfo::kGraveyardLocation;
    locations[4] = 3;
...
TEST_CASE("RoundInfo overall", "[roundinfo, round_all]") {
    ...
    REQUIRE(info.Location(0, 1) == RoundInfo::kUnknown);
    REQUIRE(info.Location(0, 2) == RoundInfo::kUnknown);
    ...
    REQUIRE(info.Location(3, 1) == RoundInfo::kUnknown);
    REQUIRE(info.Location(3, 2) == RoundInfo::kUnknown);
    REQUIRE(info.Location(3, 3) == RoundInfo::kGraveyardLocation);
    REQUIRE(info.Location(3, 4) == RoundInfo::kUnknown);
    REQUIRE(info.Location(3, RoundInfo::kOmniscientViewer)
            == RoundInfo::kGraveyardLocation);
    ...
    REQUIRE(info.DamageReceived(0, 1) == RoundInfo::kUnknown);
    REQUIRE(info.DamageReceived(0, 2) == RoundInfo::kUnknown);
    ...
    REQUIRE(info.DamageReceived(3, 1) == RoundInfo::kUnknown);
    ...
    REQUIRE(info.HealthRemaining(0, 1) == RoundInfo::kUnknown);
    REQUIRE(info.HealthRemaining(0, 2) == RoundInfo::kUnknown);
    ...
    REQUIRE(info.HealthRemaining(3, 1) == RoundInfo::kUnknown);
    REQUIRE(info.HealthRemaining(3, 2) == RoundInfo::kUnknown);
    REQUIRE(info.HealthRemaining(3, 3) == 0);
    REQUIRE(info.HealthRemaining(3, 4) == RoundInfo::kUnknown);
    REQUIRE(info.HealthRemaining(3, RoundInfo::kOmniscientViewer) == 0);
...
void TestRoundInfoViewers(RoundInfoView const& viewer0,
    ...
    REQUIRE(viewer2.Location(0) == RoundInfo::kUnknown);
    REQUIRE(viewer3.Location(0) == RoundInfo::kUnknown);
    REQUIRE(viewer4.Location(0) == 1);
    REQUIRE(viewer0.Location(1) == RoundInfo::kUnknown);
    REQUIRE(viewer1.Location(1) == 4);
    REQUIRE(viewer2.Location(1) == 4);
    REQUIRE(viewer3.Location(1) == RoundInfo::kUnknown);
    REQUIRE(viewer4.Location(1) == 4);
    REQUIRE(viewer0.Location(2) == RoundInfo::kUnknown);
    ...
    REQUIRE(viewer1.Location(3) == RoundInfo::kUnknown);
    REQUIRE(viewer2.Location(3) == RoundInfo::kUnknown);
    REQUIRE(viewer3.Location(3) == RoundInfo::kGraveyardLocation);
    REQUIRE(viewer4.Location(3) == RoundInfo::kGraveyardLocation);
    ...
    REQUIRE(viewer1.DamageReceived(0) == RoundInfo::kUnknown);
    REQUIRE(viewer2.DamageReceived(0) == RoundInfo::kUnknown);
    REQUIRE(viewer3.DamageReceived(0) == RoundInfo::kUnknown);
    REQUIRE(viewer4.DamageReceived(0) == RoundInfo::kUnknown);
    REQUIRE(viewer0.DamageReceived(1) == RoundInfo::kUnknown);
    REQUIRE(viewer1.DamageReceived(1) == 2);
    REQUIRE(viewer2.DamageReceived(1) == 2);
    REQUIRE(viewer3.DamageReceived(1) == RoundInfo::kUnknown);
    REQUIRE(viewer4.DamageReceived(1) == RoundInfo::kUnknown);
    REQUIRE(viewer0.DamageReceived(2) == RoundInfo::kUnknown);
    ...
    REQUIRE(viewer1.DamageReceived(3) == RoundInfo::kUnknown);
    ...
    REQUIRE(viewer1.HealthRemaining(0) == RoundInfo::kUnknown);
    REQUIRE(viewer2.HealthRemaining(0) == RoundInfo::kUnknown);
    REQUIRE(viewer3.HealthRemaining(0) == RoundInfo::kUnknown);
    REQUIRE(viewer4.HealthRemaining(0) == RoundInfo::kUnknown);
    REQUIRE(viewer0.HealthRemaining(1) == RoundInfo::kUnknown);
    REQUIRE(viewer1.HealthRemaining(1) == 5);
    REQUIRE(viewer2.HealthRemaining(1) == 5);
    REQUIRE(viewer3.HealthRemaining(1) == RoundInfo::kUnknown);
    REQUIRE(viewer4.HealthRemaining(1) == RoundInfo::kUnknown);
    REQUIRE(viewer0.HealthRemaining(2) == RoundInfo::kUnknown);
    ...
    REQUIRE(viewer1.HealthRemaining(3) == RoundInfo::kUnknown);
    REQUIRE(viewer2.HealthRemaining(3) == RoundInfo::kUnknown);
    REQUIRE(viewer3.HealthRemaining(3) == 0);
